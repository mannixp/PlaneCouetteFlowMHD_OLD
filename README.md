...
Typically this execution demands a compute cluster or large workstation. Referencence run-time using 32 cores, with a Modified Crank-Nicolson Adams-basforth integration is

```
2 AMD Epyc 7302 @ 3 GHz – 2*16 cores processors          - 180 cpu-hr
```

however we strongly recommend using L-stable Runge-Kutta integrators, which demand mutliples of this time.
